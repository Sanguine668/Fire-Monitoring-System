...
def build_charter() -> None:
    ...
    add_table(
        ...
        [
            ...
            ["欧阳宇康", "需求与质量负责人", "负责需求获取与需求分析，整理需求与测试相关材料；负责测试用例设计、测试执行与缺陷跟踪，输出测试记录与质量数据；配合组长完成需求确认、验收与评审材料准备。"],
            ["陈泽恩", "配置与文档协助", "在组长指导下完成文档模板套用、格式排版与归档；维护 Microsoft Project 任务库与甘特图基础数据，进度计划与最终版本由组长审定；负责演示素材、环境记录与数据集/负样本的整理归档。"],
        ],
        [2.0, 3.8, 9.6],
        center_body=False,
        font_size=Pt(9),
